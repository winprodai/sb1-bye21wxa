import { ArrowRight, Bookmark, GraduationCap } from "lucide-react";
            ...
            courses.map((course, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 border-b border-gray-200 group-hover:bg-gray-100/80 transition-colors duration-300">
                  <span
                    className={`px-2 py-0.5 text-xs font-bold rounded transform group-hover:scale-105 transition-transform duration-300 ${
                  ...
                  <h2 className="text-lg font-bold text-gray-900 group-hover:text-primary transition-colors duration-300">
                    {course.title}
                  </h2>
                </div>
