          ...
          {ebooks.map((ebook, index) => (
            ...
            >
              ...
              <div className="p-4 space-y-4 bg-white">
                <h3 className="font-bold text-lg leading-tight text-gray-900 group-hover:text-primary transition-colors duration-300">{ebook.title}</h3>
                
                {ebook.description && (
                  <p className="text-sm text-gray-600 line-clamp-3 group-hover:text-gray-900 transition-colors duration-300">{ebook.description}</p>
                )}

                {ebook.additionalInfo && (
                  <p className="text-sm text-gray-500 group-hover:text-gray-700 transition-colors duration-300">{ebook.additionalInfo}</p>
                )}
